...
def main() -> None:
    ...
    try:
        valid_mission = SpaceMission(
            ...
            destination="Mars",
            launch_date=datetime.fromisoformat("2027-03-15T09:00:00"),
            duration_days=900,
            crew=[
                CrewMember(
                    member_id="C001",
        ...
        print("Unexpected validation error for valid mission:")
        print(error)
    ...
    try:
        invalid_mission = SpaceMission(
            ...
            destination="Europa",
            launch_date=datetime.fromisoformat("2028-06-01T14:30:00"),
            duration_days=180,
            crew=[
                CrewMember(
                    member_id="C010",
